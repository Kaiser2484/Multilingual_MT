...
Hệ thống dịch thuật máy đa ngôn ngữ (Multilingual Machine Translation) sử dụng kiến trúc Transformer tự xây dựng từ đầu (from scratch) bằng PyTorch. Hệ thống hỗ trợ dịch thuật **12 chiều** giữa 4 ngôn ngữ: Tiếng Anh, Tiếng Việt, Tiếng Nhật, và Tiếng Trung.
